        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeUp delay={0.1}>
            <div className="grid lg:grid-cols-5 gap-8 items-center">
              <div
                className="lg:col-span-3 relative bg-white p-8 md:p-12 rounded-2xl border border-[#1e3a8a]/10"
                style={{
                  boxShadow:
                    "0 1px 3px rgba(30,58,138,0.04), 0 4px 12px rgba(30,58,138,0.06), 0 16px 40px rgba(30,58,138,0.06)",
                }}
              ...
              <div className="lg:col-span-2">
                <img
                  ...
                  alt="Tony Sterns and Joel demonstrating the iLidRx Pod"
                  className="w-full rounded-2xl shadow-[0_4px_24px_rgba(30,58,138,0.12)]"
                  loading="lazy"
                />
              </div>
            </div>
